                            ...
                            <div class="card-header" style="background-image: url('../assets/img/blogpost.jpg')">
                                <div class="profile-picture">
                                    <div class="avatar avatar-xl">
                                        <img src="{{ auth()->user()->profile->photo == null ? asset('backend/img/default-profile.jpg') : auth()->user()->profile->photo }}" alt="..." class="avatar-img rounded-circle">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="user-profile text-center">
                                    <div class="view-profile">
                                        <a href="javascript:void(0)" id="lfm" data-input="photo" data-preview="holder" class="btn btn-secondary btn-block">change profile</a>
