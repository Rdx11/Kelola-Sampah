                            ...
                            <form action="{{ route('items.update', $item->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="image" class="form-control" type="text" name="image" value="{{ old('image', $item->image) }}" readonly>
                                    </div>
                                </div>
                                <div id="holder">
                                    @if($item->image)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="redeem_limit" id="redeem_limit" class="form-control" value="{{ old('redeem_limit', $item->redeem_limit) }}">
                                    @error('redeem_limit')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
